...
def cryptography_has_rsa_oaep_md():
    return ["EVP_PKEY_CTX_set_rsa_oaep_md"]


def cryptography_has_rsa_oaep_label():
    return ["EVP_PKEY_CTX_set0_rsa_oaep_label"]


def cryptography_has_ssl3_method():
    return ["SSLv3_method", "SSLv3_client_method", "SSLv3_server_method"]
...
def cryptography_has_x509_store_ctx_get_issuer():
    return ["X509_STORE_get_get_issuer", "X509_STORE_set_get_issuer"]
...
def cryptography_has_oneshot_evp_digest_sign_verify():
    return ["EVP_DigestSign", "EVP_DigestVerify"]


def cryptography_has_evp_digestfinal_xof():
    return ["EVP_DigestFinalXOF"]


def cryptography_has_evp_pkey_get_set_tls_encodedpoint():
    return ["EVP_PKEY_get1_tls_encodedpoint", "EVP_PKEY_set1_tls_encodedpoint"]
...
def cryptography_has_ssl_sigalgs():
    return ["SSL_CTX_set1_sigalgs_list", "SSL_get_sigalgs"]
...
def cryptography_has_keylog():
    return ["SSL_CTX_set_keylog_callback", "SSL_CTX_get_keylog_callback"]
